...
AI assistance is permissible only when used for modifications that the contributor has already conceptualized (e.g., generating repeated lines with minor variations).
